...
export default async function OrderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const order = (db as any).retailOrders?.find((o: any) => o.id === id);
    ...
    <div style={{background:"#FAF8F4", minHeight:"100vh", fontFamily:"var(--font-jost)", color:"#1C1917"}}>
      <div style={{maxWidth:"600px", margin:"0 auto", padding:"80px 24px", textAlign:"center"}}>
        ...
        <div style={{background:"#F0EBE3", padding:"28px", textAlign:"left", marginBottom:"32px"}}>
          <h3 style={{fontSize:"13px", letterSpacing:"2px", textTransform:"uppercase", color:"#9A8F82", marginBottom:"20px"}}>Detail Pesanan</h3>
        ...
        <div style={{display:"flex", gap:"12px", justifyContent:"center", flexWrap:"wrap"}}>
          <a href={"https://wa.me/6285190311230?text=" + encodeURIComponent("Halo Henima, saya baru saja membuat pesanan dengan ID: " + order.id + ". Mohon konfirmasi pembayaran.")}
