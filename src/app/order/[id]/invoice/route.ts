...
.payment-box { background: #1C1917; padding: 24px; color: #F0EBE3; margin-bottom: 32px; }
.footer { padding-top: 32px; border-top: 1px solid rgba(28,25,23,0.1); text-align: center; }
.print-btn { position: fixed; bottom: 24px; right: 24px; background: #1C1917; color: #fff; border: none; padding: 12px 24px; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; cursor: pointer; font-family: sans-serif; }
