...
export default async function HomePage() {
  ...
  return (
    <div style={{background:"#FAF8F4", color:"#1C1917"}}>
      ...
      {/* HERO */}
      <section style={{display:"grid", gridTemplateColumns:"1fr 1fr", minHeight:"92vh", width:"100%"}} className="hero-grid">
        <div style={{background:"#F0EBE3", display:"flex", flexDirection:"column", justifyContent:"center", padding:"80px 64px 80px 8vw"}}>
          <p style={{fontSize:"10px", letterSpacing:"3px", textTransform:"uppercase", color:"#9A8F82", marginBottom:"28px", fontWeight:400}}>{company.name}</p>
          <h1 style={{fontFamily:"var(--font-cormorant)", fontSize:"clamp(52px,8vw,96px)", fontWeight:300, lineHeight:0.92, color:"#1C1917", marginBottom:"28px", letterSpacing:"-1px", fontStyle:"italic"}}>
          ...
          <p style={{fontSize:"14px", color:"#9A8F82", lineHeight:2, maxWidth:"300px", marginBottom:"48px", fontWeight:300}}>
            {company.tagline || "Setiap tetes adalah cerita. Setiap aroma adalah kenangan yang layak diingat."}
          </p>
          <div style={{display:"flex", gap:"12px", flexWrap:"wrap"}}>
            <Link href="/shop" style={{display:"inline-block", background:"#1C1917", color:"#F0EBE3", padding:"15px 40px", fontSize:"10px", letterSpacing:"3px", textTransform:"uppercase", textDecoration:"none", fontFamily:"var(--font-jost)", border:"1px solid #1C1917"}}>
              Explore
            </Link>
            <Link href="/shop" style={{display:"inline-block", background:"transparent", color:"#1C1917", padding:"14px 24px", fontSize:"10px", letterSpacing:"2px", textTransform:"uppercase", textDecoration:"none", fontFamily:"var(--font-jost)", border:"1px solid rgba(28,25,23,0.25)"}}>
              Shop Now
            </Link>
          </div>
          <div style={{display:"flex", gap:"24px", marginTop:"64px", fontSize:"9px", color:"rgba(200,184,154,0.7)", letterSpacing:"3px", textTransform:"uppercase", flexWrap:"wrap"}}>
