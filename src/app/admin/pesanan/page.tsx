            ...
            <article key={order.id} className="card">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 font-semibold">{formatRupiah(order.total)}</p>
                  <p className="text-sm">
                    Status:{" "}
                ...
                <div className="flex flex-col gap-3 sm:min-w-[260px]">
                  {order.status === "pending_confirmation" && order.paymentProof && (
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-ink-300">
                        Bukti bayar sudah diunggah. Konfirmasi untuk membuat invoice PDF.
                      </p>
                      <button type="submit" className="btn-primary mt-3 w-full">
                        Konfirmasi Pembayaran + Buat Invoice
                      </button>
                    </form>
                  )}
                  ...
                  >
                    <label className="label">Update status (one click)</label>
