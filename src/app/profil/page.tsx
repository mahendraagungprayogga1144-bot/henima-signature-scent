...
import IntimateWelcome from "@/components/IntimateWelcome";
import {
  INTIMATE_TIERS,
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F9F6F1", fontFamily: "var(--font-jost, sans-serif)" }}>
      <style>{`
        ...
        .profil-reveal-d1 { animation-delay: 0.05s; }
        .profil-reveal-d2 { animation-delay: 0.15s; }
        .profil-reveal-d3 { animation-delay: 0.25s; }
        @media (prefers-reduced-motion: reduce) {
          .profil-reveal, .tier-icon-active { animation: none !important; }
        }
      `}</style>
      ...
      <div className="profil-reveal profil-reveal-d1" style={{ background: "#fff", padding: "80px 32px" }}>
        <div style={{ textAlign: "center", marginBottom: "64px", maxWidth: "700px", margin: "0 auto 64px" }}>
          ...
          <p style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(16px,2vw,20px)", color: "#B5935A", fontStyle: "italic", marginBottom: "20px", lineHeight: 1.5 }}>
      ...
      {/* FAQ */}
      <div className="profil-reveal profil-reveal-d2" style={{ maxWidth: "720px", margin: "0 auto", padding: "80px 32px" }}>
      ...
      {/* UBAH PROFILE */}
      <div className="profil-reveal profil-reveal-d3" style={{ background: "#fff", padding: "64px 32px 80px" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", display: "flex", alignItems: "center", gap: "48px", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, minWidth: "240px" }}>
            <p style={{ fontFamily: "var(--font-cormorant)", fontSize: "20px", fontStyle: "italic", color: "#B5935A", marginBottom: "12px", lineHeight: 1.4 }}>
              Kisahmu pantas dikenang lebih dalam.
            </p>
