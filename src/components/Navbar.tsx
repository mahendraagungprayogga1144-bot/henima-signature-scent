          ...
          {user ? (
            <>
              ...
              <form action="/api/auth/logout" method="POST">
                <button
                  type="submit"
                  className="rounded-lg px-2 py-1 text-ink-200 hover:bg-ink-900/60 hover:text-red-300"
                >
                  Keluar
                </button>
              </form>
            ...
            <>
              ...
              <Link href="/daftar" className="btn-primary !py-2 !px-3">
                Daftar
              </Link>
            </>
          )}
