  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAF8F4", fontFamily: "var(--font-jost, sans-serif)", color: "#1C1917" }}>
      ...
      <section style={{ maxWidth: "720px", margin: "0 auto", padding: "100px 32px" }}>
        ...
        <p style={{ fontSize: "15px", color: "#6B5E52", lineHeight: 2, marginBottom: "24px" }}>Henima lahir dari sebuah kisah cinta jarak jauh — dua anak muda, Jakarta dan Surabaya, yang membuktikan bahwa cinta itu nyata dan abadi.</p>
        <p style={{ fontSize: "15px", color: "#6B5E52", lineHeight: 2, marginBottom: "24px" }}>Dari yang tidak mengenal parfum sama sekali, perjalanan panjang penuh keberanian, risiko, dan keyakinan mengantarkan mereka mendirikan Henima Signature Scent. Banyak orang baik yang hadir, mendukung, dan membantu hingga sampai sejauh ini.</p>
        <p style={{ fontSize: "15px", color: "#6B5E52", lineHeight: 2, marginBottom: "24px" }}>Setiap nama varian Henima lahir dari kisah nyata mereka berdua — karena kami percaya parfum bukan sekadar aroma. Ia adalah identitas diri, pengingat momen indah, dan perayaan cinta yang tak lekang oleh jarak.</p>
        <p style={{ fontSize: "16px", color: "#B5935A", lineHeight: 2, fontStyle: "italic", marginBottom: "40px", fontFamily: "var(--font-cormorant, serif)" }}>Welcome to Henima — Signature of Your Story. Karena cinta itu nyata.</p>
